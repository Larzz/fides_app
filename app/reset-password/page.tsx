...
// ✅ useSearchParams lives inside this inner component
			...
			<div className="absolute bottom-6 right-6 z-10 max-w-xs">
				<div className="bg-orange-100 rounded-lg p-4 shadow-lg">
					<p className="text-sm text-gray-800 mb-1">
						...
						<Link href="/support" className="font-bold text-orange-500 hover:underline">
							Contact support.
						</Link>
					</p>
					<p className="text-xs text-gray-700">Secure access. Your data is protected.</p>
				</div>
			</div>
		</div>
	)
...
// ✅ Suspense wraps the inner component here, in the default export
